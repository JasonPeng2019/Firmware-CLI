# Wave 1.6-B2 Skill Terminology And User-Native Sync Gap

> Status: active gap record / ground truth for current docs cleanup  
> Scope: Wave 1.6-B skill terminology, current preloaded-skill implementation, and future user-owned native skill sync  
