...
| `brain/provider_types.py` | Shared hybrid provider/session contracts: provider capabilities, native-handle metadata, compact memory entries, compaction helpers, prompt bundles, `ProviderTurn`, and `DecisionProvider`. |
