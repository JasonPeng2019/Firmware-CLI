...
class EventKinds:
    ...
    PROVIDER_PROGRESS: EventKind = "provider_progress"
    PROVIDER_MEMORY_UPDATE: EventKind = "provider_memory_update"
    PROVIDER_RESUME_FAILED: EventKind = "provider_resume_failed"
...
EVENT_KINDS: tuple[EventKind, ...] = (
    ...
    EventKinds.PROVIDER_PROGRESS,
    EventKinds.PROVIDER_MEMORY_UPDATE,
    EventKinds.PROVIDER_RESUME_FAILED,
